...
//nous créons un compteur pour lire les valeurs toutes les 1 minute
...
void loop(void)
{
   ...
   //si il s'est écoulé 1 minute depuis la dernière demande de température
{
...
//Zone SD
  ...
  //nous ajoutons 1 minutes à rolltime pour que arduino interroge à nouveau la température au bout de 1 minutes
  rolltime += ONEMIN;
   }//fin du if rolltime
}//fin de loop
